...
class GPCM_Activator
{
    public static function activate(): void
    {
        ...
        $sql[] = "CREATE TABLE {$prefix}students (
            id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
            ...
            preferred_venue_id BIGINT UNSIGNED NULL,
            preferred_class_type_id BIGINT UNSIGNED NULL,
        ...
        $sql[] = "CREATE TABLE {$prefix}inscriptions (
            id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
            ...
            class_type_name VARCHAR(120) NULL,
            availability TEXT NULL,
            available_days VARCHAR(255) NULL,
            observations TEXT NULL,
            season VARCHAR(80) NULL,
            status VARCHAR(30) NOT NULL DEFAULT 'pending',
            source_plugin VARCHAR(40) NULL,
            source_form_id VARCHAR(80) NULL,
        ...
        $sql[] = "CREATE TABLE {$prefix}attendance (
            ...
            consumes_class TINYINT(1) NOT NULL DEFAULT 1,
            generates_recovery TINYINT(1) NOT NULL DEFAULT 0,
            recovery_id BIGINT UNSIGNED NULL,
            created_at DATETIME NOT NULL,
            updated_at DATETIME NOT NULL,
            PRIMARY KEY (id),
